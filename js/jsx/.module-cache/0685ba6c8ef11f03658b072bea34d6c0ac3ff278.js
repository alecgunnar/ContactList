  ...
  render: function() {
    return (
      React.createElement("tr", {rel: this.props.data.idx}, 
        ...
        React.createElement("td", {className: "email"}, this.props.data.email), 
        React.createElement("td", {className: "phone"}, this.props.data.phone), 
        React.createElement("td", {className: "position"}, positions[this.props.data.position]), 
...
React.render(
  React.createElement(ContactListBody, {url: "data.json", pollInterval: 500}),
