  ...
  render: function() {
    return (
      React.createElement("tr", null, 
        ...
        React.createElement("td", null, React.createElement(ContactListItemOptions, {index: this.props.key}))
      )
    );
  }
});
...
var ContactList = React.createClass({displayName: "ContactList",
  render: function() {
    var contactNodes = this.props.contacts.map(function (contact) {
      return (
        React.createElement(ContactListItem, {key: contact.idx, data: contact})
      );
    });
