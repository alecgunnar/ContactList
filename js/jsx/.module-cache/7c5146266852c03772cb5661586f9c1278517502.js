  ...
  render: function() {
    return (
      React.createElement("ul", null, 
        React.createElement("li", null, React.createElement("button", {className: "modify-record"}, "Modify")), 
        React.createElement("li", null, React.createElement("button", {className: "remove-record"}, "Remove"))
      )
    );
  }
});
